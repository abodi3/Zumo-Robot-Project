...
\vspace{-22pt}\begin{lstlisting}[language=C,caption={Simple PD Control},label=PD\_Control.c]
//PD Control
...
\vspace{-22pt}\begin{lstlisting}[language=C,caption={Sumo Behaviour},label=Sumo.c]
int distance;
