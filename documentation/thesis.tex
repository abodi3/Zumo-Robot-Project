...
\begin{tabular}{ | p{4,7cm} | p{10,3cm} |}
  ...
  \multicolumn{2}{|p{15cm}|}{
  	Projects aim is to develop an embedded software for Zumo robot controll. This documentation covers the theoretical and practical aspects required during development. Necessary mathematical, physical and electronic concepts also presented.
  } \\[14cm] \hline
