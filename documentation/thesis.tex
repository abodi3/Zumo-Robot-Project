...
As shown in code snippet in , the motor\_forward function takes uint8 (unsinged 8bit Integer) value of 100 which represents the speed value as the first value
